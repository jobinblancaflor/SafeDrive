...
export default async function AdminIncidentsPage() {
  ...
  // Pull emergency contacts so the detail panel can show them when an admin
  // selects an incident from the live list. The list itself is fetched from
  // /api/incidents on the client so it stays realtime-updated.
  ...
  // Keep the profile reference to make sure server-side RBAC is exercised.
  void profile;
